 ...
 */
class PdfVersionConverterTest extends TestCase
{
    protected $tmp;
    ...
    public function testMustConvertPDFVersionWithSuccess($file, $newVersion)
    {
        ...
        $content = (new PdfVersionConverter)->convertTo14(file_get_contents($file));

        file_put_contents($tmpFile, $content);

        $version = (new PdfVersionConverter)->guess(file_get_contents($tmpFile));
